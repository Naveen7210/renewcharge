            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ url('serviceproviders') }}" enctype="multipart/form-data" >
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <x-input-label for="sp_code" :value="__('sp_code')" />
                            <x-text-input id="sp_code" class="block mt-1 w-full" type="text" placeholder="sp_code" name="sp_code" :value="old('sp_code')" autofocus autocomplete="username" />
                            <x-input-error :messages="$errors->get('sp_code')" class="mt-2" />
                        </div>
                    </div>
